...
const simpleChangeTypes = new Set([
  ...
  ChangeType.FieldArgumentDeprecationAdded,
  ChangeType.FieldArgumentDeprecationRemoved,
  ChangeType.FieldArgumentDeprecationReasonChanged,
  ChangeType.FieldArgumentDeprecationReasonAdded,
  ...
  ChangeType.InputFieldDeprecationReasonAdded,
